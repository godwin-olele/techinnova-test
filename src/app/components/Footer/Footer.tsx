    ...
    <div className="bg-secondaryColor h-[360px] px-[60px] py-[100px] w-full">
      <div className="flex justify-between">
        <div className="flex flex-col space-y-3">
          <h1 className="text-[21px] font-[700] text-white leading-tight poppins">SHORT LINE ABOUT US <br /> THREE WORDS HERE</h1>
          <p className="text-white text-[13px] font-[500]">Short sentence here</p>
        </div>

        <div className="flex space-x-20">
          <h1 className="uppercase text-white text-[21px] leading-tight font-[700] poppins">Connect <br /> With <br /> Us</h1>
          <div className="space-y-7">
            <div className="flex space-x-2 items-center cursor-pointer">
              <p className="text-white text-[13px] font-[500] poppins">Twitter</p>
